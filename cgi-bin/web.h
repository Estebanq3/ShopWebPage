...
void split_cookies(string hilera_cookies, string cookies_splitted[2]);

// trim from end (in place)
string rtrim(const std::string &s);

// trim from begining (in place)
...
void split_cookies(string hilera_cookies, string cookies_splitted[2]){
	...
	while(iterator < hilera_cookies.length()){

		if(hilera_cookies.at(iterator) == '='){
			++iterator;
			while(iterator < hilera_cookies.length() && hilera_cookies.at(iterator) != ';'){

				cookies_splitted[cookieN] += hilera_cookies.at(iterator);
